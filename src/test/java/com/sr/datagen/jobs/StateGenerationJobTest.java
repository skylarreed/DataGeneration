...
//@ContextConfiguration(classes = {StateGenerationJob.class, TransactionReader.class, StateProcessor.class,
//        ListTransactionReader.class, StatePopulator.class})
//@TestExecutionListeners({DependencyInjectionTestExecutionListener.class, DirtiesContextTestExecutionListener.class})
//@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_CLASS)
//@TestPropertySource(properties = "spring.batch.job.name=stateJob")
//public class StateGenerationJobTest {
//
//    @Autowired
...
//                .addString("fileOutputPath", "src/test/resources/output/test_states.xml")
...
//
//        FileSystemResource expectedOutput = new FileSystemResource("src/test/resources/output/test_states.xml");
