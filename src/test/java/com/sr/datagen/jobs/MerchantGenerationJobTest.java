...
//@ContextConfiguration(classes = {MerchantGenerationJob.class, TransactionReader.class, MerchantGeneratorProcessor.class,
//        ListTransactionReader.class, MerchantNameGenerator.class})
//@TestExecutionListeners({DependencyInjectionTestExecutionListener.class, DirtiesContextTestExecutionListener.class})
//@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_CLASS)
//@TestPropertySource(properties = "spring.batch.job.name=merchantJob")
//public class MerchantGenerationJobTest {
//
//    @Autowired
...
//                .addString("fileOutputPath", "src/test/resources/output/test_merchants.xml")
...
//
//        FileSystemResource expectedOutput = new FileSystemResource("src/test/resources/output/test_merchants.xml");
